...
string Web3::Web3Sha3(const string* data) {
	...
	LOG("OUTPUT before getString: ");
	LOG(output.c_str());
	string returnVal = getString(&output);
	LOG("Contract::Web3Sha3 - Return");
	LOG(returnVal.c_str());
    LOG("Contract::Web3Sha3 - Return");
...
string Web3::exec(const string* data) {
    ...
    while (client.connected()) {
		...
		LOG("LOGGING LINE $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        LOG(line.c_str());
		LOG("LOGGING LINE END $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        if (line == "\r") {
			LOG("line reading while client connected failed");
			LOG("line before exiting: ");
			LOG(line.c_str());
            break;
        }
    }
	
	LOG("Exitted while(client.connected())");
